class DUMMY_DATA {
  static const List<Map<String, dynamic>> data = [
    {
      'name': 'Burger Patriots',
      'description': 'Burger with cheddar, bacon and barbecue sauce',
      'price': 'R\$ 20.00',
      'image':
    ...
    {
      'name': 'Pizza',
      'description': 'Pizza with mozzarella, tomato and basil',
      'price': 'R\$ 30.00',
      'image':
    ...
    {
      'name': 'Cappuccino',
      'description': 'Cappuccino with chocolate and cinnamon',
      'price': 'R\$ 10.00',
      'image':
    ...
    {
      'name': 'Salad',
      'description': 'Salad with lettuce, tomato and cucumber',
      'price': 'R\$ 15.00',
      'image':
    ...
    {
      'name': 'Pancakes',
      'description': 'Pancakes with honey and fruits',
      'price': 'R\$ 20.00',
      'image':
